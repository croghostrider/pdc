...
plt.text(6.1, 30, f'Measured Offset: {str(np.round(SP1[-1] - T1[-1], 2))}')
offset = 60 - (23+0.9*Kc*60)/(1+0.9*Kc)
plt.text(6.1, 26, f'Calculated Offset: {str(np.round(offset, 2))}')
plt.text(6.1, 22, f'$K_c$: {str(np.round(Kc, 2))}')
